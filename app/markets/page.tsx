...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title =
    'Direktori Pasar Malam Malaysia | Senarai Pasar Malam Mengikut Negeri';
  const description =
    'Lihat senarai pasar malam seluruh Malaysia mengikut negeri dan hari: KL, Selangor, Johor, Pulau Pinang, Negeri Sembilan dan lain-lain. Cari pasar malam terdekat dengan kemudahan dan waktu operasi.';
