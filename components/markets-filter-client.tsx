...
export default function MarketsFilterClient({ initialMarkets, initialState }: MarketsFilterClientProps) {
  ...
  const itemListData = {
    ...
    description: "Complete directory of night markets across Malaysia with operating hours, amenities, and locations",
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked: boolean) => setFilters((prev) => ({ ...prev, parking: !!checked }))}
                      className="size-5 border-2 shadow-sm hover:border-foreground data-[state=checked]:border-primary"
                    />
                    <label
                      htmlFor="parking"
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked: boolean) => setFilters((prev) => ({ ...prev, toilet: !!checked }))}
                      className="size-5 border-2 shadow-sm hover:border-foreground data-[state=checked]:border-primary"
                    />
                    <label
                      htmlFor="toilet"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {t.showingResults} {Math.min(visibleCount, filteredAndSortedMarkets.length)} {t.of}{" "}
                    {filteredAndSortedMarkets.length} {t.markets}
                  </p>
                </div>
