...
export default function ContributorsClient() {
  ...
  const contributors: Contributor[] = [
    ...
    {
      name: "Meor Muhammad Hakimi",
      role: "Data Contributor",
      link: "https://www.linkedin.com/in/meor-hakimi-314b9024b/",
    },
    { name: "Afifah", role: "Data Contributor", link: "https://www.linkedin.com/in/nurul-afifah-818a85169/" },
    {
      name: "GitHub Contributors",
      role: "Developer & Maintainer",
      link: "https://github.com/muazhazali/caripasarmalam/graphs/contributors",
    },
    {
      name: "nawicon",
      role: "Icon Designer",
      link: "https://www.flaticon.com/free-icon/shop_5193727?term=location&related_id=5193727",
    },
  ];
