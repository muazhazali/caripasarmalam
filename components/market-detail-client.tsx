                  ...
                  <div className="space-y-4">
                    ...
                    {market.location ? (
                      <InteractiveMap
                        ...
                        className="w-full h-80 md:h-64 z-2"
                      />
                    ) : (
                    ...
                    {market.location && (
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="cursor-pointer hover:text-white dark:hover:bg-gray-800"
                        >
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Link href={`/markets?state=${encodeURIComponent(market.state)}`}>
                    <Button
                      variant="outline"
                      className="w-full mt-3 bg-transparent cursor-pointer hover:text-white dark:hover:bg-gray-800"
                    >
                      {language === "ms"
                        ? `${t.browseStateMarkets} ${t.markets} ${market.state}`
                        : `${t.browseStateMarkets} ${market.state} ${t.markets}`}
                    </Button>
                  </Link>
                </CardContent>
              </Card>
